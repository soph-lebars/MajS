...
'''
Scrip allow to transform the observed file .obs and the network file .cif into another format .lp which is usable by clingo 

input : Take all observation file present in the repertory and the network in cif format


output : Will give lp file that correspond to the information present inside cif and obs file in form of predicate
'''
import os, sys
